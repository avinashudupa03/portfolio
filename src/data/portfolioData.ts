...
export const personalInfo = {
  ...
  github: 'https://github.com/avinashudupa03',
  linkedin: 'https://www.linkedin.com/in/avinash-udupa-214a34322',
...
export const certifications = [
  {
    ...
    issuer: 'Microsoft',
    description: 'Microsoft Linux certification.',
    icon: '🐧',
  ...
  },
  {
    ...
    color: 'from-orange-500 to-red-500',
    skills: ['Linux CLI', 'Shell Scripting', 'File Systems', 'System Admin'],
    certificate: '/Linux.google.pdf',
  },
  {
    title: 'SQL Basics',
    issuer: 'Microsoft',
    description: 'Microsoft SQL certification.',
    icon: '🗄️',
  ...
  },
  {
    ...
    color: 'from-blue-500 to-cyan-500',
    skills: ['SQL Queries', 'Database Design', 'Joins & Aggregations', 'MySQL'],
    certificate: '/Sql.google.pdf',
  },
  {
    title: 'Android Development',
    issuer: 'Certification Program',
    description: 'Android application development certification.',
    icon: '📱',
